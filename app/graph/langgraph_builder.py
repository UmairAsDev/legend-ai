...
class CodingState(TypedDict, total=False):
    ...
    procedures: List[dict]   # standardized ProcedureInstance objects (serialised)
    sites: List[dict]        # Phase 1: ProcedureSite objects (serialised as dicts)
    em_data: dict
    candidates: list
    llm_output: dict
...
def build_graph():
    ...
    graph.add_edge("billing_params", "site_builder")     # Phase 1 runs before retrieval
    graph.add_edge("site_builder",   "web_lookup")
