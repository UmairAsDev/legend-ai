    ...
    async with async_db_session() as db:
        try:
            query = text(
                ...
                WHERE
                    (npn.mohsNotes LIKE "%Dermaplanning%")
                    OR (npn.biopsyNotes LIKE "%Dermaplanning%")
                    OR (npn.procedure LIKE "%Dermaplanning%")
...
def append_to_json(new_data, file_path="dermaplanning_id.json"):
    """
